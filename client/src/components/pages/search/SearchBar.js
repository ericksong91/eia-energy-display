...
function SearchBar({ onStatesFilter }) {
      ...
      <form className="searchbar-form p-3">
        ...
        <div className="relative">
          ...
          <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg 
            ...
            dark:focus:border-blue-500" placeholder="Search for States..." value={searchText} onChange={(e) => handleChange(e.target.value)} required />
