...
function GraphCard({ fuelData, fuelLabels }) {
    ...
    return (
        <div className='graphcard p-4 m-4 rounded-lg shadow bg-light-main sm:bg-light-seco hover:bg-opacity-90 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 fade-in-left'>
            {
                type === "line"
