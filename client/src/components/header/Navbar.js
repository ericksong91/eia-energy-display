...
function Navbar() {
  ...
  const buttonsList = [homeIcon, aboutIcon].map((x) => {
    return <button className='bg-slate-200 rounded p-2 mx-3'>
      {x}
    </button>
  });

  return (
    <section className='navbar container flex w-full'>
      <div className='buttons flex'>
        {buttonsList}
      </div>

      <div className='lightdark-mode container flex justify-end'>
        <label class="inline-flex items-center cursor-pointer">
          ...
          <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 
            ...
            peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full 
